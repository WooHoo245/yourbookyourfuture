					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Có {{count($new_product)}} sản phẩm ở đây</p>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$new->id)}}"><img src="source/image/product/{{$new->image}}" alt="" height="250"></a>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Có {{count($sanpham_khuyenmai)}} sản phẩm ở đây</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt="" height="250"></a>
										</div>
										<div class="single-item-body">
